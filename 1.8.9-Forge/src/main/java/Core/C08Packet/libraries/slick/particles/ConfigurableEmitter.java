...
import Core.C08Packet.libraries.slick.util.FastTrig;
...
public class ConfigurableEmitter implements ParticleEmitter {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.particles.ParticleEmitter#update(Core.C08Packet.libraries.slick.particles.ParticleSystem,
	 *      int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.particles.ParticleEmitter#updateParticle(Core.C08Packet.libraries.slick.particles.Particle,
	 *      int)
	 */
