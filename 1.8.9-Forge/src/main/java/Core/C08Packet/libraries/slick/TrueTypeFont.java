...
import Core.C08Packet.libraries.slick.opengl.GLUtils;
...
import Core.C08Packet.libraries.slick.util.BufferedImageUtil;
 ...
 */
public class TrueTypeFont implements Core.C08Packet.libraries.slick.Font {
	...
	public void drawString(float x, float y, String whatchars,
			Core.C08Packet.libraries.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, Core.C08Packet.libraries.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           Core.C08Packet.libraries.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, Core.C08Packet.libraries.slick.Color.white);
	}
