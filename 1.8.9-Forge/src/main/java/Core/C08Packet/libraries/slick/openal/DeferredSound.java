...
public class DeferredSound extends AudioImpl implements DeferredResource {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#isPlaying()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#playAsMusic(float, float, boolean)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#stop()
	 */
	public void stop() {
		checkTarget();
		target.stop();
