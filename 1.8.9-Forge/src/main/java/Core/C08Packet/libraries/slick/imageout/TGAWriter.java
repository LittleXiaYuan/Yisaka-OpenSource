package Core.C08Packet.libraries.slick.imageout;
...
public class TGAWriter implements ImageWriter {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.imageout.ImageWriter#saveImage(Core.C08Packet.libraries.slick.Image, String, OutputStream, boolean)
	 */
