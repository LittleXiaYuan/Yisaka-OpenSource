...
public class CanvasGameContainer extends Canvas {
	...
	private class Container extends AppGameContainer {
		...
		/**
		 * @see Core.C08Packet.libraries.slick.GameContainer#running()
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.GameContainer#getHeight()
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.GameContainer#getWidth()
		 */
		public int getWidth() {
