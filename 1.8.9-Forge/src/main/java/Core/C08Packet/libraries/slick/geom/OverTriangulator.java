...
public class OverTriangulator implements Triangulator {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Triangulator#addPolyPoint(float, float)
	 */
	public void addPolyPoint(float x, float y) {
	}

	/**
	 * @see Core.C08Packet.libraries.slick.geom.Triangulator#getTriangleCount()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Triangulator#getTrianglePoint(int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Triangulator#startHole()
	 */
	public void startHole() {
	}

	/**
	 * @see Core.C08Packet.libraries.slick.geom.Triangulator#triangulate()
	 */
