...
public class PNGImageData implements LoadableImageData {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.LoadableImageData#loadImage(InputStream)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.LoadableImageData#loadImage(InputStream, boolean, int[])
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.LoadableImageData#loadImage(InputStream, boolean, boolean, int[])
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.LoadableImageData#configureEdging(boolean)
	 */
