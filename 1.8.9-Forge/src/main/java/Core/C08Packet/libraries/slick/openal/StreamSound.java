...
public class StreamSound extends AudioImpl {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#setPosition(float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioImpl#getPosition()
	 */
