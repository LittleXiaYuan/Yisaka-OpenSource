package Core.C08Packet.libraries.slick;
...
import Core.C08Packet.libraries.slick.opengl.ImageData;
import Core.C08Packet.libraries.slick.opengl.ImageDataFactory;
import Core.C08Packet.libraries.slick.opengl.LoadableImageData;
import Core.C08Packet.libraries.slick.opengl.Texture;
import Core.C08Packet.libraries.slick.opengl.renderer.SGL;
import Core.C08Packet.libraries.slick.opengl.renderer.Renderer;
import Core.C08Packet.libraries.slick.util.OperationNotSupportedException;
import Core.C08Packet.libraries.slick.util.ResourceLoader;
...
public class BigImage extends Image {
	 ...
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#bind()
	 */
	public void bind() {
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#copy()
	 */
	public Image copy() {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw()
	 */
	public void draw() {
		draw(0,0);
	}
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, Core.C08Packet.libraries.slick.Color)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float, Core.C08Packet.libraries.slick.Color)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float, float, Core.C08Packet.libraries.slick.Color)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float, float, float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawEmbedded(float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawFlash(float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawFlash(float, float)
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#endUse()
	 */
	public void endUse() {
		if (lastBind != null) {
			lastBind.endUse();
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#startUse()
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#ensureInverted()
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#getColor(int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#getFlippedCopy(boolean, boolean)
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#getGraphics()
	 */
	...
	/** 
	 * @see Core.C08Packet.libraries.slick.Image#getScaledCopy(float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#getScaledCopy(int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#getSubImage(int, int, int, int)
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#getTexture()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#initImpl()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#reinit()
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see Core.C08Packet.libraries.slick.Image#setTexture(Core.C08Packet.libraries.slick.opengl.Texture)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#toString()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#draw(float, float, float, float, float, float, float, float, Core.C08Packet.libraries.slick.Color)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawCentered(float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawEmbedded(float, float, float, float, float, float, float, float, Core.C08Packet.libraries.slick.Color)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawEmbedded(float, float, float, float, float, float, float, float)
	 */
	public void drawEmbedded(float x, float y, float x2, float y2, float srcx,
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawFlash(float, float, float, float, Core.C08Packet.libraries.slick.Color)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Image#drawSheared(float, float, float, float)
	 */
