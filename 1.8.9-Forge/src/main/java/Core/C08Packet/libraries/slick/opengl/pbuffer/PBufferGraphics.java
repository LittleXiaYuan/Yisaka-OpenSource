package Core.C08Packet.libraries.slick.opengl.pbuffer;
...
public class PBufferGraphics extends Graphics {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Graphics#disable()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Graphics#enable()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Graphics#destroy()
	 */
	public void destroy() {
		super.destroy();
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Graphics#flush()
	 */
	public void flush() {
		super.flush();
