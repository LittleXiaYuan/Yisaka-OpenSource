package Core.C08Packet.libraries.slick.geom;
...
public class Line extends Shape {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Shape#getX()
	 */
	public float getX() {
		return getX1();
	}
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Shape#getY()
	 */
	public float getY() {
		return getY1();
	}
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Shape#createPoints()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Shape#transform(Core.C08Packet.libraries.slick.geom.Transform)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Shape#closed()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.geom.Shape#intersects(Core.C08Packet.libraries.slick.geom.Shape)
	 */
