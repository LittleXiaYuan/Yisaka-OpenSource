package Core.C08Packet.libraries.slick.util.pathfinding;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import Core.C08Packet.libraries.slick.util.pathfinding.heuristics.ClosestHeuristic;
...
public class AStarPathFinder implements PathFinder, PathFindingContext {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.util.pathfinding.PathFindingContext#getMover()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.util.pathfinding.PathFindingContext#getSearchDistance()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.util.pathfinding.PathFindingContext#getSourceX()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.util.pathfinding.PathFindingContext#getSourceY()
	 */
