...
import Core.C08Packet.libraries.slick.util.InputAdapter;
...
public class InputProvider {
	...
	private class InputListenerImpl extends InputAdapter {
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#isAcceptingInput()
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#keyPressed(int, char)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#keyReleased(int, char)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#mousePressed(int, int, int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#mouseReleased(int, int, int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerLeftPressed(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerLeftReleased(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerRightPressed(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerRightReleased(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerUpPressed(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerUpReleased(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerDownPressed(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerDownReleased(int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerButtonPressed(int,
		 *      int)
		 */
		...
		/**
		 * @see Core.C08Packet.libraries.slick.util.InputAdapter#controllerButtonReleased(int,
		 *      int)
		 */
