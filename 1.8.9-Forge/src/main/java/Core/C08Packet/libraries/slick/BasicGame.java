...
public abstract class BasicGame implements Game, InputListener {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Game#closeRequested()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Game#getTitle()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.Game#update(Core.C08Packet.libraries.slick.GameContainer, int)
	 */
