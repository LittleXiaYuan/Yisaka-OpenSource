...
public class OggInputStream extends InputStream implements AudioInputStream {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioInputStream#getChannels()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioInputStream#getRate()
	 */
	public int getRate() {
		return oggInfo.rate;
	}
	...
	/**
	 * @see Core.C08Packet.libraries.slick.openal.AudioInputStream#atEnd()
	 */
