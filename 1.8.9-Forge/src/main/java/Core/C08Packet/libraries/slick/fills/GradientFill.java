package Core.C08Packet.libraries.slick.fills;
...
public class GradientFill implements ShapeFill {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.ShapeFill#getOffsetAt(Core.C08Packet.libraries.slick.geom.Shape, float, float)
	 */
