package Core.C08Packet.libraries.slick.muffin;
...
public class FileMuffin implements Muffin {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.muffin.Muffin#saveFile(HashMap,
	 *      String)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.muffin.Muffin#loadFile(String)
	 */
