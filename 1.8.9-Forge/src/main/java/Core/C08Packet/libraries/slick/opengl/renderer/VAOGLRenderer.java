...
public class VAOGLRenderer extends ImmediateModeOGLRenderer {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#initDisplay(int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#flush()
	 */
	public void flush() {
		super.flush();
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glBegin(int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glColor4f(float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glEnd()
	 */
	public void glEnd() {
		if (listMode > 0) {
			super.glEnd();
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexCoord2f(float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex2f(float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex3f(float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glBindTexture(int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glBlendFunc(int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glCallList(int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glClear(int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glClipPlane(int, DoubleBuffer)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glColorMask(boolean, boolean, boolean, boolean)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glDisable(int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glEnable(int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glLineWidth(float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glPointSize(float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glPopMatrix()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glPushMatrix()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glRotatef(float, float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glScalef(float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glScissor(int, int, int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexEnvi(int, int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glTranslatef(float, float, float)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glEndList()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.opengl.renderer.ImmediateModeOGLRenderer#glNewList(int, int)
	 */
