package Core.C08Packet.libraries.slick.gui;
...
import Core.C08Packet.libraries.slick.Sound;
...
public class MouseOverArea extends AbstractComponent {
	...
	/**
	 * @see Core.C08Packet.libraries.slick.gui.AbstractComponent#render(Core.C08Packet.libraries.slick.gui.GUIContext,
	...
	/**
	 * @see Core.C08Packet.libraries.slick.util.InputAdapter#mouseMoved(int, int, int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.util.InputAdapter#mouseDragged(int, int, int, int)
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.gui.AbstractComponent#getHeight()
	 */
	...
	/**
	 * @see Core.C08Packet.libraries.slick.gui.AbstractComponent#getWidth()
	 */
	public int getWidth() {
