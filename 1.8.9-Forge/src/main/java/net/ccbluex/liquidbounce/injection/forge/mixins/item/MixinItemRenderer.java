            ...
            if(this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (enumaction) {
                    ...
                    case DRINK:
                        ...
                        break;
                    case BLOCK:
                        Animation blockAnimations = (Animation) LiquidBounce.moduleManager.getModule(Animation.class);
                ...
                Animation Ani = (Animation) LiquidBounce.moduleManager.getModule(Animation.class);
