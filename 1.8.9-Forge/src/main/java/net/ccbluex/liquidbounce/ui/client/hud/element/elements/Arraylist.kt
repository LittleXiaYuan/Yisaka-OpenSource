                    ...
                    RainbowFontShader.begin(colorMode == "Rainbow", if (rainbowX.get() == 0.0F) 0.0F else 1.0F / rainbowX.get(), if (rainbowY.get() == 0.0F) 0.0F else 1.0F / rainbowY.get(), System.currentTimeMillis() % 10000 / 10000F).use {
                        fontRenderer.drawString(displayString, xPos - if (rectMode.equals("right", true)) 3 else 0, yPos + textY,
                                when(colorMode.toLowerCase()) {
                                    ...
                                    "rainbow3" -> ColorManager.getRainbow2(2000, -(yPos * rainbow3Offset.get().toFloat()).toInt())
                            ...
                            when(rectMode.toLowerCase()) {
                                ...
                                "outline" -> {
                                    RenderUtils.drawRect(-1F, yPos - 1F, 0F,
                                            yPos + textHeight, rectColor)//右条
                                    RenderUtils.drawRect(xPos - outLineRectWidth.get(), yPos ,xPos - outLineRectWidth.get() + 1, yPos + textHeight,
                                            rectColor)//左条
                                    if (module == modules[0]) {
                                    ...
                                    if (module != modules[0]) {
                                        ...
                                        RenderUtils.drawRect(xPos - outLineRectWidth.get() - (fontRenderer.getStringWidth(displayStrings) - fontRenderer.getStringWidth(displayString)), yPos, xPos - outLineRectWidth.get() + 1, yPos + 1,
                                                rectColor) //功能左条和下条间隔
                        ...
                        RainbowFontShader.begin(colorMode == "Rainbow", if (rainbowX.get() == 0.0F) 0.0F else 1.0F / rainbowX.get(), if (rainbowY.get() == 0.0F) 0.0F else 1.0F / rainbowY.get(), System.currentTimeMillis() % 10000 / 10000F).use {
                            val rectColor = when (rectColorMode.toLowerCase()) {
                                ...
                                "rainbow3" -> ColorManager.getRainbow2(
                                        2000,
                                        -(yPos * rainbow3Offset.get().toFloat()).toInt()
                                )
