...
import Core.C08Packet.utils.Packet.PacketUtils;
...
@ModuleInfo(name = "Fly", description = "", category = ModuleCategory.MOVEMENT, keyBind = Keyboard.KEY_F)
public class Fly extends Module {
    ...
    private final IntegerValue aac520Purse = new IntegerValue("AAC5.2.0Purse",70,50,200);
