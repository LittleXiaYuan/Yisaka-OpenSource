...
public class Scaffold extends Module {
    ...
    // Mode
    public final ListValue modeValue = new ListValue("Mode", new String[] {"Normal", "Rewinside", "Expand", "AAC5"}, "Normal");
    ...
    private final BoolValue HypixelMod = new BoolValue("HypixelMod",false);
    ...
    private final FloatValue AAC5Speed = new FloatValue("AAC5Speed", 0.1F, 0.11F, 0.99F);
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        shouldGoDown = downValue.get() && GameSettings.isKeyDown(mc.gameSettings.keyBindSneak) && getBlocksAmount() > 0.5;
        if (shouldGoDown)
    ...
    public void onMove(final MoveEvent event) {
        ...
        if (HypixelMod.get()) {
            MovementUtils.setMotion(0.11);

            if (modeValue.equals("AAC5")) {
            MovementUtils.setMotion(AAC5Speed.get());
            }
        }
    }
    /**
