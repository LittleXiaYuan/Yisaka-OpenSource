    ...
    public void onMotion() {
        if(MovementUtils.isMoving()) {
            ...
            if(mc.thePlayer.onGround) {
                ...
                float speed = MovementUtils.getSpeed() < 0.56F ? MovementUtils.getSpeed() * 1.000F : 0.56F;

                if(mc.thePlayer.onGround && mc.thePlayer.isPotionActive(Potion.moveSpeed))
                    speed *= 1F + 0.1F * (1 + mc.thePlayer.getActivePotionEffect(Potion.moveSpeed).getAmplifier());
            ...
            MovementUtils.strafe(MovementUtils.getSpeed() * 1.0F);
        }else{
