...
@ModuleInfo(name = "NoFall", description = "AntiFallDamage", category = ModuleCategory.PLAYER)
public class NoFall extends Module {
    public final ListValue modeValue = new ListValue("Mode", new String[]{"SpoofGround", "NoGround", "Packet", "OldAAC", "LAAC", "AAC3.3.11", "AAC3.3.15", "AACv4", "NekoJump", "Spartan", "CubeCraft", "Hypixel", "Verus", "Crash", "HypixelNew", "HypixelAnother"}, "SpoofGround");
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        switch(modeValue.get().toLowerCase()) {
            ...
            case "Crash": {
                if (mc.thePlayer.fallDistance > 2F && mc.thePlayer.fallDistance < 200F) {
                    mc.thePlayer.onGround = false;
                    mc.getNetHandler().addToSendQueue(new C03PacketPlayer(true));
                }
                break;
