...
public class ColorManager {
    ...
    public static int Astolfo(int var2) {
        double d = 0;
        double v1 = Math.ceil((double)(System.currentTimeMillis() + (long)(var2 * 109))) / 5.0;
        return Color.getHSBColor((float)((double)((float)(d / 360.0)) < 0.5 ? -((float)(v1 / 360.0)) : (float)((v1 %= 360.0) / 360.0)), (float)0.5f, (float)1.0f).getRGB();
    }
}
